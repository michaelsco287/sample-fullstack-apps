...
func TestGetOwnedBooks(t *testing.T) {
	...
	assert.Equal(t, "[{\"Title\":\"Frederick Douglass: Prophet of Freedom\",\"Authors\":[\"David W. Blight\"],\"Publishers\":[\"Simon \\u0026 Schuster\"],\"DatePublished\":\"2018\",\"CoverURL\":\"https://covers.openlibrary.org/b/id/8312265-L.jpg\"}]\n", wGet.Body.String())
}
